...
export const en = {
  ...
  'worship.sadaqahEditor': 'Sadaqah details',
  'worship.sadaqahAmount': 'Amount (optional)',
  'worship.sadaqahNote': 'Note (optional)',
  'worship.sadaqahNotePlaceholder': 'e.g. food for a neighbor',
  'worship.sadaqahHistory': 'Recent gifts',
  'worship.sadaqahEmpty': 'No gifts logged yet — the first one takes a second.',
  'worship.sadaqahLogged': 'Logged — may it be accepted.',
  'worship.undo': 'Undo',
  ...
  'audio.versePackDone': 'Downloaded {n} of {m} ayahs.',
  'palette.open': 'Quick search (Ctrl+K)',
  'palette.navigate': 'Go to',
  'palette.surah': 'Surahs',
  'palette.ayah': 'Quran verses',
  'palette.library': 'Adhkar & duas',
  'palette.reciter': 'Reciters',
  ...
  'nav.offline': 'Offline library',
  'offline.lead': 'Download every on-demand book once, then read anywhere — no connection needed.',
  ...
  'offline.group.mushaf': 'Mushaf pages',
  'offline.group.hadith': 'Ahadeeth books',
  'offline.group.tafsir': 'Tafsir',
  'offline.group.words': 'Word study data',
  'offline.complete': 'Downloaded',
  'offline.partial': '{done}/{total} files',
  ...
  'offline.audioOpen': 'Open Audio downloads',
  'offline.needOnline': 'Connect to the internet first.',
  'offline.lowStorage': 'Not enough free storage for this download.',
  'offline.started': 'Downloading {n} files — keep this tab open.',
  'offline.done': 'All downloaded — ready for offline.',
  'offline.doneWithErrors': 'Finished with errors — run again to complete.',
  'offline.cancelled': 'Stopped — progress is saved.',
  'offline.compressedOn': 'Compressed storage on — cleared old downloads.',
  'offline.compressedOff': 'Standard storage on — cleared old downloads.',
  ...
  'hifz.reveal': 'Reveal',
  'hifz.testOff': 'No test',
  'hifz.testFirstword': 'First-word',
  'hifz.testMcq': 'Quiz me',
  'hifz.mcqTitle': 'Which translation matches?',
  'hifz.mcqNew': 'Next question',
  ...
  'audio.repeatAll': 'Repeat all surahs',
  ...
  'favorites.sortRecent': 'Recent',
  'favorites.sortAlpha': 'A–Z',
  'favorites.moveTo': 'Move to collection',
  'favorites.unfavoriteAll': 'Remove all',
  ...
  'tasbih.customAdd': 'Add custom dhikr',
  'tasbih.customPlaceholder': 'Type your dhikr…',
  'tasbih.customEmpty': 'Type a phrase first',
  'tasbih.customAdded': 'Custom dhikr saved',
  'tasbih.customRemove': 'Remove custom dhikr',
  ...
  'prayer.addToCalendar': 'Add to calendar',
  ...
  'calendar.recurWeekly': 'Every week',
  'calendar.recurMonthly': 'Every month',
  'calendar.recurYearly': 'Every year',
  'calendar.recurHijriMonthly': 'Every Hijri month',
  ...
  'settings.dyslexiaFriendly': 'Dyslexia-friendly reading (wider spacing)',
  'settings.roomySpacing': 'Roomier text spacing',
  ...
  'settings.dataBackupStale': 'Export a backup — last export {n} day(s) ago.',
  ...
  'settings.exportPlan': 'Share Plan (file)',
  'settings.importPlan': 'Import Shared Plan',
  'plan.exported': 'Plan file created — send it to your family.',
  'plan.importConfirm':
  ...
  'editor.fieldReferenceAr': 'Arabic source name (optional)',
  'editor.fieldBook': 'Book (optional)',
  'editor.fieldChapter': 'Chapter (optional)',
  ...
  'editor.fieldReferenceNotes': 'Reference notes (optional)',
  ...
  'stats.sheet.shareWeek': 'Share my week',
  'stats.sheet.exportCsv': 'Export CSV',
  'stats.sheet.shareCsv': 'Share CSV',
  ...
  'settings.hidePanel': 'Show / hide panel',
  'home.panel.ramadan': 'Ramadan banner',
  'home.panel.checklist': 'Daily checklist',
  'home.panel.continue': 'Continue reading',
  'home.panel.progress': 'Daily progress',
  'home.panel.verse': 'Verse of the day',
  'home.panel.hadith': 'Daily hadith',
  'home.panel.hifz': 'Hifz review',
  'home.panel.worship': 'Worship today',
  'home.panel.recent': 'Recently read',
  'home.panel.favorites': 'Favorites',
  'home.panel.collections': 'Collections',
  'settings.profiles': 'Family profiles',
  'settings.profilesHint':
    'Each person keeps their own favorites, counters, streaks and history on this device. Settings (language, reciter, prayer place) stay shared.',
  'settings.profileMain': 'Main',
  'settings.profileNew': 'New person',
  'settings.profileNewTitle': 'Name this person',
  'settings.profileNamePh': 'e.g. Layla',
  'settings.profileCreated': 'Profile created',
  'settings.profileSwitched': 'Profile switched',
  'settings.profileDeleted': 'Profile deleted',
  'settings.profileDeleteConfirm': 'Delete this profile and all its saved progress?',
  'settings.profileDeleteActive': 'Switch away from this profile first',
  'settings.elderMode': 'Elderly mode (larger text + targets)',
  'settings.elderHint':
    'One tap: extra-large type, bigger touch targets, high contrast. Turning it off keeps your sizes.',
  'settings.kidsMode': 'Kids mode (simple Quran for children)',
  'settings.kidsHint':
    'Big tiles, short surahs, stars for finished listens. Children leave only by holding the exit button.',
  'kids.title': 'Kids Quran',
  'kids.hello': 'As-salamu alaykum!',
  'kids.listen': 'Listen to the Quran',
  'kids.listenHint': 'Tap a surah to hear it. Listening to the very end earns a star!',
  'kids.tasbih': 'Tasbih counter',
  'kids.tasbihHint': 'Tap the big circle to count your dhikr',
  'kids.stars': 'stars',
  'kids.todayStars': '{n} today',
  'kids.starsHint': 'One star for every surah you finish listening to.',
  ...
  'stats.gapHandoff': 'Advance → follow',
  'stats.gapEffect': 'Follow work',
  'stats.gapLongtasks': 'Long tasks',
  'stats.gapUnsupported': 'Long-task observation is unsupported on this browser.',
  'stats.gapClear': 'Clear samples',
  'stats.gapCleared': 'Gap samples cleared.',
  'stats.gapLocalOnly': 'Opt-in. Samples stay on this device and are never uploaded.',
  ...
  'onboarding.notificationsPrime': 'Get prayer-time alerts on this device.',
  ...
  'journal.pageStatus': '{from}–{to} of {total} · page {p}/{pages}',
  ...
  'audio.rangeToSurah': 'End surah (for cross-surah ranges)',
  ...
  'grammar.start': 'Start drill',
  'grammar.loading': 'Gathering words…',
  'grammar.empty': 'No grammar words loaded — check your connection and try again',
  'grammar.prompt': 'What part of speech is this word?',
  'grammar.reveal': 'Reveal',
  'grammar.right': 'I knew it',
  'grammar.wrong': 'Not yet',
  'grammar.progress': '{i}/{n} · {r} right',
  'grammar.done': 'Round done — {r}/{n} right',
