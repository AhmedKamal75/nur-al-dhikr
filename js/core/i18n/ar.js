...
export const ar = {
  ...
  // (v5.17.6) لافتة الشهادة أعلى الرئيسية. النص ثابت بالعربية ولا يُترجم؛
  ...
  'ramadan.plannerTitle': 'التراويح وقيام الليل',
  'ramadan.plannerHint':
    'سجلّك الخاص لعبادة الليل في رمضان هذا. اضغط ليلة مضت لتسجيلها — الليالي القادمة تُفتح يومًا بيوم.',
  'ramadan.taraweeh': 'ليالي التراويح',
  'ramadan.taraweehNight': 'ليلة التراويح {n}',
  'ramadan.itikaf': 'أيام الاعتكاف',
  'ramadan.itikafDay': 'يوم الاعتكاف {n}',
  ...
  'worship.sadaqahEditor': 'تفاصيل الصدقة',
  'worship.sadaqahAmount': 'المبلغ (اختياري)',
  'worship.sadaqahNote': 'ملاحظة (اختيارية)',
  'worship.sadaqahNotePlaceholder': 'مثال: طعام لجار',
  'worship.sadaqahHistory': 'العطاء الأخير',
  'worship.sadaqahEmpty': 'لا عطاء مسجل بعد — الأول يأخذ ثانية.',
  'worship.sadaqahLogged': 'تم التسجيل — تقبل الله.',
  'worship.undo': 'تراجع',
  ...
  'audio.versePackDone': 'نُزّلت {n} من {m} آية.',
  'palette.open': 'بحث سريع (Ctrl+K)',
  'palette.navigate': 'انتقال إلى',
  'palette.surah': 'السور',
  'palette.ayah': 'آيات القرآن',
  'palette.library': 'الأذكار والأدعية',
  ...
  // v5.3.0: offline library (one-tap bulk text downloads)
  'nav.offline': 'المكتبة دون اتصال',
  'offline.lead': 'حمّل كل الكتب مرة واحدة، ثم اقرأ في أي مكان — دون حاجة للاتصال.',
  'offline.downloadAll': 'تحميل الكل (نحو {mb} م.ب)',
  'offline.stop': 'إيقاف',
  'offline.downloading': 'جارٍ التحميل…',
  'offline.groupsTitle': 'مجموعات المحتوى',
  'offline.group.quran': 'نص القرآن',
  'offline.group.translations': 'الترجمات',
  'offline.group.mushaf': 'صفحات المصحف',
  'offline.group.hadith': 'كتب الحديث',
  'offline.group.tafsir': 'التفسير',
  'offline.group.words': 'بيانات دراسة الكلمات',
  'offline.complete': 'تم التحميل',
  'offline.partial': '{done}/{total} ملف',
  'offline.notDownloaded': 'غير محمّل',
  ...
  'offline.audioOpen': 'فتح التنزيلات الصوتية',
  'offline.needOnline': 'اتصل بالإنترنت أولًا.',
  'offline.lowStorage': 'لا توجد مساحة كافية لهذا التحميل.',
  'offline.started': 'جارٍ تحميل {n} ملف — أبقِ هذه الصفحة مفتوحة.',
  'offline.done': 'تم التحميل — جاهز دون اتصال.',
  'offline.doneWithErrors': 'انتهى مع أخطاء — أعد التشغيل للإكمال.',
  'offline.cancelled': 'توقف — تم حفظ التقدم.',
  'offline.compressedOn': 'التخزين المضغوط مفعّل — مُسحت التحميلات القديمة.',
  'offline.compressedOff': 'التخزين العادي مفعّل — مُسحت التحميلات القديمة.',
  ...
  'audio.fallbackVoice': 'تعذر الوصول إلى خادم القارئ — يتم التشغيل بصوت {name} بدلاً منه.',
  ...
  'hifz.reveal': 'إظهار',
  'hifz.testOff': 'بدون اختبار',
  'hifz.testFirstword': 'الكلمة الأولى',
  'hifz.testMcq': 'اختبرني',
  'hifz.mcqTitle': 'أي ترجمة تطابق؟',
  'hifz.mcqNew': 'سؤال تالٍ',
  ...
  'audio.repeatAll': 'تكرار كل السور',
  ...
  'mushaf.pageShort': 'ص',
  'mushaf.loadFailed': 'تعذّر تحميل صفحة المصحف التالية. تحقّق من الاتصال ثم حاول مرة أخرى.',
  ...
  'home.theme.any': 'الكل',
  'home.theme.mercy': 'الرحمة',
  'home.theme.patience': 'الصبر',
  ...
  'favorites.sortRecent': 'الأخير',
  'favorites.sortAlpha': 'A–Z',
  'favorites.moveTo': 'نقل إلى مجموعة',
  'favorites.unfavoriteAll': 'إزالة الكل',
  'favorites.clearConfirm': 'إزالة كل المفضلة؟ لا يمكن التراجع عن هذا.',
  ...
  'mushaf.waqf_lazim': 'لازم · يجب الوقف',
  'mushaf.waqf_lazim_d': 'وقف واجب.',
  'mushaf.waqf_jim': 'جائز · الوجهان سواء',
  'mushaf.waqf_jim_d': 'يستوي الوقف والوصل.',
  'mushaf.waqf_sila': 'الوصل أولى',
  'mushaf.waqf_sila_d': 'الوصل أولى وأفضل.',
  'mushaf.waqf_qila': 'الوقف أولى',
  'mushaf.waqf_qila_d': 'الوقف أولى وأفضل.',
  'mushaf.waqf_murakhkhas': 'مرخّص · رخصة في الوقف',
  'mushaf.waqf_murakhkhas_d': 'رخّص في الوقف على الوجهين.',
  'mushaf.waqf_hizb': 'الحزب · علامة تقسيم',
  ...
  'collections.rename': 'تعديل الاسم',
  ...
  'tasbih.customAdd': 'إضافة ذكر مخصص',
  'tasbih.customPlaceholder': 'اكتب الذكر هنا…',
  'tasbih.customEmpty': 'اكتب العبارة أولاً',
  'tasbih.customAdded': 'تم حفظ الذكر المخصص',
  'tasbih.customRemove': 'حذف الذكر المخصص',
  ...
  'prayer.adhanVolume': 'مستوى صوت التنبيه',
  'prayer.quietEnabled': 'ساعات الهدوء (صوت منخفض ليلًا)',
  'prayer.quietStart': 'الهدوء من',
  'prayer.quietEnd': 'الهدوء حتى',
  ...
  'prayer.addToCalendar': 'أضف إلى التقويم',
  ...
  'prayer.locationHelpTitle': 'تم حجب الوصول إلى الموقع',
  'prayer.locationHelpIntro': 'يمكنك السماح للموقع من أذونات هذا الموقع في المتصفح، أو اختيار مدينة تقريبية بدلًا من ذلك.',
  'prayer.locationHelpStep1': 'افتح معلومات الموقع أو رمز القفل بجانب عنوان هذه الصفحة.',
  'prayer.locationHelpStep2': 'افتح الأذونات أو إعدادات الموقع ثم ابحث عن إذن الموقع.',
  'prayer.locationHelpStep3': 'غيّر إذن الموقع إلى سماح، ثم ارجع إلى نور الذكر وحاول مرة أخرى.',
  'prayer.locationHelpStep4': 'إن لم ترغب في منح إذن الموقع، اختر مدينة من القائمة. إحداثيات المدن تقريبية.',
  'prayer.chooseCityShort': 'اختر مدينة',
  'prayer.chooseCityPlaceholder': 'اختر مدينة (اختياري)',
  'prayer.useManualLocation': 'استخدم مدينة أو أدخل الإحداثيات',
  ...
  'qibla.needleUncorrected': 'الشمال المغناطيسي، ولا يتوفر تصحيح الانحراف هنا.',
  ...
  'wordStudy.provenance': 'المصدر',
  'wordStudy.sourceCorpus': 'طبقة المدونة المضمّنة (ليست استشهادًا بطبعة كلاسيكية)',
  'wordStudy.stateNotAttested': 'غير مُثبت في الطبقة المضمّنة — بانتظار المراجعة العلمية؛ لم يُخترع شيء.',
  'wordStudy.stateNotApplicable': 'لا ينطبق على هذا النوع من الكلمات؛ لم يُخترع شيء.',
  ...
  'calendar.recurWeekly': 'كل أسبوع',
  'calendar.recurMonthly': 'كل شهر',
  'calendar.recurYearly': 'كل سنة',
  'calendar.recurHijriMonthly': 'كل شهر هجري',
  ...
  'settings.dyslexiaFriendly': 'قراءة مناسبة لعسر القراءة (تباعد أكبر)',
  'settings.roomySpacing': 'تباعد أكبر للنص',
  ...
  'settings.reciterB': 'القارئ الثاني (للمقارنة)',
  ...
  'settings.jumuahReminderTime': 'وقت تذكير الجمعة',
  'settings.dailyVerseReminder': 'إشعار آية اليوم',
  'settings.dailyVerseReminderTime': 'وقت آية اليوم',
  'settings.zakatFitrReminder': 'تذكير زكاة الفطر (28 رمضان)',
  'settings.zakatFitrHint': 'يُطلق مرة صباح 28 رمضان من كل عام.',
  'preset.jumuah': 'الجمعة: تذكير بسورة الكهف',
  'preset.dailyVerse': 'إشعار الآية اليومية',
  'preset.jumuahTitle': 'الجمعة: اقرأ سورة الكهف',
  'preset.jumuahBody': 'وأكثر من الصلاة على النبي ﷺ.',
  'preset.dailyVerseLabel': 'آية اليوم',
  'preset.dailyVerseBody': 'آيتك وحديثك اليوميان بانتظارك في الشاشة الرئيسية.',
  'preset.exists': 'مُضاف مسبقًا — راجع تذكيراتك',
  'preset.added': 'تمت الإضافة — يمكنك تغيير وقتها في أي وقت',
  ...
  'settings.dataBackupStale': 'صدّر نسخة احتياطية — آخر تصدير قبل {n} يوم.',
  ...
  'settings.exportPlan': 'مشاركة الخطة (ملف)',
  'settings.importPlan': 'استيراد خطة مشتركة',
  'plan.exported': 'تم إنشاء ملف الخطة — أرسله إلى عائلتك.',
  'plan.importConfirm': 'تطبيق هذه الخطة فوق بياناتك؟ سجلاتك وسجلك والمفضلة تبقى كما هي.',
  'plan.importDone': 'تم تطبيق الخطة.',
  'plan.badFile': 'هذا الملف ليس خطة مشتركة.',
  ...
  'about.guide': 'دليل المزايا — انقر للفتح',
  'about.guideHint': 'كل ما يلي يفتح في موضعه مباشرة. ابدأ من أي مكان.',
  'about.guide.mushaf': 'قارئ المصحف',
  'about.guide.journal': 'دفتر الدعاء',
  'about.gd.mushaf':
    '٦٠٤ صفحات مدنية، صفحتان متقابلتان على الشاشات الواسعة، تكبير بالقرص، ملء شاشة حقيقي.',
  'about.gd.quran': 'قارئ الدراسة: وسوم كلمة بكلمة، تفسير، مقارنة الترجمات، تلاوة مع المتابعة.',
  'about.gd.hadith': 'ثمانية كتب، ٣٤٢٣٩ حديثًا، بحث دون اتصال، علامات، نسخ واستماع.',
  'about.gd.library': 'أذكار الصباح والمساء، ٤١ بابًا من الأدعية، مفضلة، مجموعات، وضع التركيز.',
  'about.gd.prayer': 'مواقيت فلكية، عدّاد للصلاة القادمة، شريط اليوم الكامل، تصدير .ics.',
  'about.gd.qibla': 'بوصلة مصححة بالانحراف المغناطيسي، ورابط خريطة لأقرب مسجد.',
  'about.gd.tasbih': 'عدّاد باهتزاز، وتنبيه كل N نقرة، وهدف يومي وتتابع.',
  'about.gd.ramadan': 'عدّاد السحور والإفطار، متابعة الصيام، وسجلات التراويح والعشر الأواخر.',
  'about.gd.zakat': 'زكاة ٧ أصناف، زكاة الفطر، تذكير الحول، وسجل الصدقات.',
  'about.gd.journal': 'أدعيتك بكلماتك، مؤرخة، مع علامة الإجابة.',
  'about.gd.calendar': 'تقويم هجري بملاحظات وتذكيرات ومواسم الصيام.',
  'about.gd.statistics': 'التتابع، وخريطة النشاط، وسرعة القراءة وتوقع الختمة — كلها على جهازك.',
  'about.verifyNote':
  ...
  'editor.fieldReferenceAr': 'اسم المصدر بالعربية (اختياري)',
  'editor.fieldBook': 'الكتاب (اختياري)',
  'editor.fieldChapter': 'الفصل (اختياري)',
  'editor.fieldHadithNumber': 'رقم الحديث / الآية',
  'editor.fieldNarrator': 'الراوي (اختياري)',
  'editor.fieldGrading': 'تفاصيل الدرجة (اختياري)',
  'editor.fieldReferenceNotes': 'ملاحظات المرجع (اختياري)',
  ...
  'hadith.unknownNumber': 'لا يوجد حديث برقم {n} في هذا الكتاب — تحقق من الرابط.',
  ...
  'stats.readingToday': 'قراءة اليوم',
  'stats.sheet.shareWeek': 'مشاركة أسبوعي',
  'stats.sheet.exportCsv': 'تصدير CSV',
  'stats.sheet.shareCsv': 'مشاركة CSV',
  'stats.exportEmpty': 'لا شيء للتصدير بعد.',
  'stats.exportedCsv': 'حُفظ ملف الإحصاءات في التنزيلات.',
  'stats.shareTitle': 'أسبوعي في الذكر',
  'settings.homePanels': 'لوحات الرئيسية',
  'settings.homePanelsHint':
    'أعد ترتيب الشاشة الرئيسية وأخفِ ما لا تستخدمه. اللوحات المخفية تبقى هنا لتستعيدها.',
  'settings.moveUp': 'نقل لأعلى',
  'settings.moveDown': 'نقل لأسفل',
  'settings.hidePanel': 'إظهار / إخفاء اللوحة',
  'home.panel.ramadan': 'بانر رمضان',
  'home.panel.checklist': 'القائمة اليومية',
  'home.panel.continue': 'مواصلة القراءة',
  'home.panel.progress': 'تقدم اليوم',
  'home.panel.verse': 'آية اليوم',
  'home.panel.hadith': 'حديث اليوم',
  'home.panel.hifz': 'مراجعة الحفظ',
  'home.panel.worship': 'عبادة اليوم',
  'home.panel.recent': 'قُرئ مؤخرًا',
  'home.panel.favorites': 'المفضلة',
  'home.panel.collections': 'المجموعات',
  'settings.profiles': 'ملفات العائلة',
  'settings.profilesHint':
    'كل شخص يحتفظ بمفضلته وعداداته وسلاسله وسجله على هذا الجهاز. تبقى الإعدادات (اللغة والقارئ ومكان الصلاة) مشتركة.',
  'settings.profileMain': 'الرئيسي',
  'settings.profileNew': 'شخص جديد',
  'settings.profileNewTitle': 'سمِّ هذا الشخص',
  'settings.profileNamePh': 'مثال: ليلى',
  'settings.profileCreated': 'أُنشئ الملف',
  'settings.profileSwitched': 'تم التبديل للملف',
  'settings.profileDeleted': 'حُذف الملف',
  'settings.profileDeleteConfirm': 'حذف هذا الملف وكل تقدمه المحفوظ؟',
  'settings.profileDeleteActive': 'انتقل لملف آخر أولًا',
  'settings.elderMode': 'وضع كبار السن (نص وأهداف أكبر)',
  'settings.elderHint':
    'نقرة واحدة: خط كبير جدًا وأهداف لمس أكبر وتباين عالٍ. إيقافه يُبقي أحجامك.',
  'settings.kidsMode': 'وضع الأطفال (قرآن بسيط للصغار)',
  'settings.kidsHint':
    'بلاطات كبيرة وسور قصيرة ونجوم للاستماع الكامل. لا يخرج الأطفال إلا بالضغط المطوّل على زر الخروج.',
  'kids.title': 'قرآن الأطفال',
  'kids.hello': 'السلام عليكم!',
  'kids.listen': 'استمع إلى القرآن',
  'kids.listenHint': 'المس سورة لسماعها. الاستماع حتى النهاية يكسب نجمة!',
  'kids.tasbih': 'عداد التسبيح',
  'kids.tasbihHint': 'المس الدائرة الكبيرة لعدّ ذكرك',
  'kids.stars': 'نجمة',
  'kids.todayStars': '{n} اليوم',
  'kids.starsHint': 'نجمة لكل سورة تستمع إليها حتى النهاية.',
  ...
  'stats.gapTitle': 'قياس فجوة المتابعة',
  'stats.gapHint': 'يقيس التأخير بين تقدّم التلاوة والمتابعة على الشاشة في هذا الجهاز.',
  'stats.gapEnable': 'تسجيل عينات فجوة المتابعة',
  'stats.gapEmpty': 'لا عيّنات بعد — رتّل بوضع الآيات مع تفعيل المتابعة.',
  'stats.gapSamples': '{n} عيّنة',
  'stats.gapHandoff': 'التقدّم ← المتابعة',
  'stats.gapEffect': 'عمل المتابعة',
  'stats.gapLongtasks': 'مهام طويلة',
  'stats.gapUnsupported': 'مراقبة المهام الطويلة غير مدعومة في هذا المتصفح.',
  'stats.gapClear': 'مسح العيّنات',
  'stats.gapCleared': 'تم مسح عيّنات الفجوة.',
  'stats.gapLocalOnly': 'اختياري. تبقى العيّنات على هذا الجهاز ولا تُرفع أبدًا.',
  ...
  'onboarding.notificationsPrime': 'لتصلك تنبيهات مواقيت الصلاة على هذا الجهاز.',
  ...
  'journal.pageStatus': '{from}–{to} من {total} · صفحة {p}/{pages}',
  ...
  'audio.loop': 'تكرار',
  'audio.loopMode': 'تكرار هذا النطاق عدة مرات',
  'audio.loopOn': 'تكرار النطاق ×{n}',
  'audio.loopOff': 'إيقاف التكرار — يُشغَّل مرة واحدة',
  'playlist.title': 'قوائم التلاوة',
  'playlist.hint':
  ...
  'playlist.empty': 'لا نطاقات في هذه القائمة بعد — احفظ واحدًا من أي منتقي نطاق',
  'playlist.noQueues': 'لا قوائم بعد — أنشئ واحدة ثم احفظ النطاقات فيها.',
  'playlist.deleted': 'حُذفت القائمة',
  'playlist.deleteConfirm': 'حذف هذه القائمة وكل نطاقاتها؟',
  'playlist.addedRange': 'حُفظ النطاق في القائمة',
  'playlist.saveRange': 'حفظ النطاق في قائمة',
  'playlist.saveRangeBtn': 'حفظ في القائمة',
  'playlist.unresolvable': 'تعذّر تحميل أيٍّ من هذه النطاقات — تحقق من الاتصال',
  'mushaf.playSurahOnPage': 'تلاوة سورة من هذه الصفحة',
  'mushaf.playSurahHint': 'هذه الصفحة تحوي أكثر من سورة — اختر أيّها تُتلى.',
  ...
  'audio.rangeToSurah': 'سورة النهاية (للنطاقات العابرة للسور)',
  ...
  'prayer.timelineLabel': 'مواقيت الصلاة على مدار اليوم، مع علامة توضح الوقت الحالي',
  ...
  'hadith.bookmark': 'حفظ الحديث في العلامات',
  'hadith.unbookmark': 'إزالة العلامة',
  'hadith.bookmarked': 'المحفوظات',
  'hadith.bookmarkedToast': 'حُفظ الحديث',
  'hadith.unbookmarked': 'أُزيلت العلامة',
  'hadith.note': 'ملاحظتي',
  'hadith.noteTitle': 'ملاحظة على هذا الحديث',
  'hadith.notePh': 'تأملك أو سياقك أو تذكيرك…',
  'hadith.addNote': 'إضافة ملاحظة شخصية',
  'hadith.editNote': 'تحرير ملاحظتك',
  'hadith.noteSaved': 'حُفظت الملاحظة',
  ...
  'grammar.start': 'بدء التدريب',
  'grammar.loading': 'جارٍ جمع الكلمات…',
  'grammar.empty': 'تعذّر تحميل كلمات النحو — تحقق من الاتصال وحاول مجددًا',
  'grammar.prompt': 'ما نوع هذه الكلمة؟',
  'grammar.reveal': 'كشف',
  'grammar.right': 'عرفتها',
  'grammar.wrong': 'ليس بعد',
  'grammar.progress': '{i}/{n} · {r} صحيحة',
  'grammar.done': 'انتهت الجولة — {r}/{n} صحيحة',
  'grammar.restart': 'جولة جديدة',
  'grammar.exit': 'إنهاء التدريب',
