...
const dict = {
  en: {
    ...
    'ramadan.whiteDayToday':
      'Today is a White Day (Ayyam al-Beedh) \u2014 a recommended fasting day',
    'ramadan.shawwalTitle': 'Six Days of Shawwal',
    'ramadan.shawwalFasts': 'Shawwal fasts logged',

    'khatm.title': 'Reading Plan (Khatm)',
    'khatm.subtitle':
      'Set a pace to finish the whole Mushaf and track your progress from wherever you left off.',
    'khatm.days': 'In {n} days',
    'khatm.onePagePerDay': 'One page a day',
    'khatm.pages': 'pages',
    'khatm.onTrack': 'On track \u2014 keep it up',
    'khatm.behind': 'Behind pace \u2014 read {n} pages/day to catch up',
    'khatm.overdue': 'Past the target date \u2014 you can restart with a new pace anytime',
    'khatm.completed': 'Mashallah, you completed it! \ud83c\udf89',
    'khatm.continueReading': 'Continue reading',
    'khatm.cancel': 'Cancel plan',

    'qada.title': 'Missed Prayers (Qada\u2019)',
    'qada.subtitle': 'A private tally to help you keep track of prayers you still need to make up.',
    'qada.increment': 'Add one missed prayer',
    'qada.decrement': 'Mark one as made up',

    'prayer.lastThird': 'The last third of the night begins at',

    'nav.sadaqah': 'Sadaqah',
    'sadaqah.title': 'Sadaqah Log',
    'sadaqah.subtitle':
      'A private, ongoing record of your charitable giving \u2014 separate from your yearly Zakat.',
    'sadaqah.thisMonth': 'This month',
    'sadaqah.allTime': 'All time',
    'sadaqah.addEntry': 'Add Entry',
    'sadaqah.amount': 'Amount',
    'sadaqah.causeLabel': 'Cause',
    'sadaqah.date': 'Date',
    'sadaqah.note': 'Note (optional)',
    'sadaqah.notePlaceholder': 'e.g. Friday collection',
    'sadaqah.history': 'History',
    'sadaqah.empty': 'No entries yet \u2014 add your first one above.',
    'sadaqah.cause.general': 'General Sadaqah',
    'sadaqah.cause.masjid': 'Masjid / Mosque',
    'sadaqah.cause.orphans': 'Orphans',
    'sadaqah.cause.family': 'Family & Relatives',
    'sadaqah.cause.zakat': 'Zakat',
    'sadaqah.cause.other': 'Other',
  ...
  ar: {
    ...
    'ramadan.whiteDayToday': 'اليوم من الأيام البيض — يوم صيام مستحب',
    'ramadan.shawwalTitle': 'ستة أيام من شوال',
    'ramadan.shawwalFasts': 'صيامًا من شوال مسجلاً',

    'khatm.title': 'خطة القراءة (الختمة)',
    'khatm.subtitle': 'حدّد وتيرة لإتمام المصحف كاملاً وتابع تقدمك من حيث توقفت.',
    'khatm.days': 'خلال {n} يومًا',
    'khatm.onePagePerDay': 'صفحة واحدة يوميًا',
    'khatm.pages': 'صفحة',
    'khatm.onTrack': 'أنت على المسار الصحيح — واصل',
    'khatm.behind': 'متأخر عن الخطة — اقرأ {n} صفحة/يوم للحاق بالركب',
    'khatm.overdue': 'تجاوزت الموعد المستهدف — يمكنك البدء من جديد بوتيرة جديدة في أي وقت',
    'khatm.completed': 'ما شاء الله، أتممتها! \ud83c\udf89',
    'khatm.continueReading': 'متابعة القراءة',
    'khatm.cancel': 'إلغاء الخطة',

    'qada.title': 'الصلوات الفائتة (القضاء)',
    'qada.subtitle': 'سجلّ خاص يساعدك على تتبع الصلوات التي ما زلت بحاجة لقضائها.',
    'qada.increment': 'إضافة صلاة فائتة',
    'qada.decrement': 'تسجيل قضاء صلاة',

    'prayer.lastThird': 'يبدأ الثلث الأخير من الليل الساعة',

    'nav.sadaqah': 'الصدقة',
    'sadaqah.title': 'سجلّ الصدقات',
    'sadaqah.subtitle': 'سجلّ خاص ومستمر لصدقاتك — منفصل عن زكاتك السنوية.',
    'sadaqah.thisMonth': 'هذا الشهر',
    'sadaqah.allTime': 'الإجمالي',
    'sadaqah.addEntry': 'إضافة سجل',
    'sadaqah.amount': 'المبلغ',
    'sadaqah.causeLabel': 'الجهة',
    'sadaqah.date': 'التاريخ',
    'sadaqah.note': 'ملاحظة (اختياري)',
    'sadaqah.notePlaceholder': 'مثال: جمع يوم الجمعة',
    'sadaqah.history': 'السجل',
    'sadaqah.empty': 'لا توجد سجلات بعد — أضف أول سجل أعلاه.',
    'sadaqah.cause.general': 'صدقة عامة',
    'sadaqah.cause.masjid': 'المسجد',
    'sadaqah.cause.orphans': 'الأيتام',
    'sadaqah.cause.family': 'الأهل والأقارب',
    'sadaqah.cause.zakat': 'الزكاة',
    'sadaqah.cause.other': 'أخرى',
